export const traumaSymptoms = [
    ...
    // Criteria E
    {label: 'The Criteria is not met for Autism Spectrum Disorder', value: 8},

    // Criteria F
    {label: 'Disturbance is evident before age 5 years old', value: 9},

    // Criteria G
    {label: 'Has a developmental age of 9 months', value: 10},

    // Disinhibited Social Engagement Disorder
    // Criteria A (two of the following)
    {label: 'Unrestraint approach / interaction to unfamiliar adults', value: 11},
    {label: 'Familiar verbal / physical behavior', value: 12},
    {label: 'Absent checking back with caregivers after venturing away, even in unfamiliar setting', value: 13},
    ...
    {label: 'Recurrent / Involuntary / Intrusive Distressing memories of the traumatic event', value: 23},
    {label: 'Recurrent distressing dreams related to the traumatic event', value: 24},
    {label: 'Flashbacks', value: 25},
    {label: 'Intense / Prolonged distress', value: 26},
    {label: 'Physiological reaction to cues that symbolize the traumatic event', value: 27},

    // Criteria C (one or both symptoms)
    {label: 'Avoidance to distressing memories / thoughts / feelings / closely associated with the traumatic event', value: 28},
    ...
    {label: 'Diministhed interest / participation in significant activities ', value: 34},
    {label: 'Feeling of detachment / estrangement to others', value: 35},
    ...
    // Criteria G
    {label: 'Causes Clinically Significant Distress', value: 43},
    {label: 'Impairment in social and other functioning', value: 44},

    // Criteria H
    {label: 'The disturbance is not attributable to a susbtance or medical condition', value: 45},
    ...
    {label: 'Recurrent Distressing Dreams', value: 49},
    {label: 'Flashbacks', value: 50},
    {label: 'Intense Psychological Distress to cues that symbolize the traumatic event', value: 51},
    ...
    // Criteria G: The disturbance is not attributable to a susbtance or medical condition
    ...
    {label: 'Recurrent / Involuntary / Intru999sive Distressing memories of the traumatic event', value: 67},
    ...
    // Criteria C: Duration of the disturbance (symptoms in Criterion B) is 3 days to 1 month after trauma exposure.
    // Critieria D: "The disturbance causes clinically significant distress or impairment in relationships with parents, siblings, peers, or other caregivers or with school behavior.
    // Criteria E" The disturbance is not attributable to a susbtance or medical condition

    // Adjustment Disorder
    // Occuring 3 months Onset
    // Criteria A
    {label: 'The development of emotional or behavioral symptoms in response to an identifiable stressor', value: 80},

    // Criteria B
    {label: 'Marked Distress that is out of proportion to the intensity of stressor', value: 81},
    {label: 'Impairment in Social Functioning / Occupational Functioning / Other areas of Functioning', value: 82},

    // Criteria C: The stress related disturbance does not meet the criteria for another mental disorder or preexisting mental disorder
    // Criteria D: The symptoms do not represent normal bereavement and are not better explained by prolonged grief disorder.
    // Criteria E: Once the stressor or its consequences have terminated, the symptoms do not persist for more than an additional 6 months.

    // Prolonged Grief Disorder
    // Criteria A
    {label: 'The death, at least 12 months ago, of a person who was close to the bereaved individual (for children and adolescents, at least 6 months ago)', value: 83},

    // Criteria B: Symptoms occured nearly everyday
    {label: 'Intensed yearning / longing for the deceased person', value: 84},
    {label: 'Preoccupied with thoughts / memories of the deceased person', value: 85},
    // Frequency: Everyday
    ...
    // Criteria D: "The duration and severity of the bereavement reaction clearly exceed expected social, cultural, or religious norms for the individual’s culture and context.
    // Criteria E	"not better explained by another mental disorder, such as major depressive disorder or posttraumatic stress disorder, and are not attributable to the physiological effects of a substanceor another medical condition.
